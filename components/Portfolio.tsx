          ...
          {PROJECTS.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Category Tag */}
                <div className="absolute top-4 left-4 z-20 px-3 py-1 bg-black/80 backdrop-blur text-neon-cyan text-xs font-bold uppercase tracking-wider border border-neon-cyan/20">
                  {project.category}
                </div>
              </div>
              ...
              <div className="p-8 relative">
                <div className="absolute top-0 right-8 -translate-y-1/2 w-12 h-12 bg-neon-cyan text-void rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-[-50%] transition-all duration-300 shadow-[0_0_20px_rgba(6,182,212,0.6)] z-20 cursor-pointer hover:scale-110">
